#+TITLE: Library as a Gem - harfbuzz
#+LATEX: \pagebreak

* Overview

  ~laag-harfbuzz~ packages [[https://github.com/harfbuzz/harfbuzz][harfbuzz]] as a Ruby Gem, using [[https://github.com/colstrom/laag][laag]].
...
* Updating this Package
  ...
  #+BEGIN_SRC shell
    git-vendor update harfbuzz 1.7.6
  #+END_SRC
